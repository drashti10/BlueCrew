import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:bluecrew/presentation/speciallization_screen/models/speciallization_model.dart';part 'speciallization_event.dart';part 'speciallization_state.dart';/// A bloc that manages the state of a Speciallization according to the event that is dispatched to it.
